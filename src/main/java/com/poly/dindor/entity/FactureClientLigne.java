...
@Entity
@Table(name = "facture_client_ligne")
@Getter @Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class FactureClientLigne {
    ...
    @Column(name = "prix_revient", precision = 15, scale = 3)
    @Builder.Default
    private BigDecimal prixRevient = BigDecimal.ZERO;
    ...
    public void calculer() {
        ...
        BigDecimal prixRemise = prixUnitaireHT.multiply(BigDecimal.ONE.subtract(tauxRemise));
